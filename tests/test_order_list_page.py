...
class TestOrderList:
    ...
    def test_make_order_and_check_order_list(self, user, driver):
        ...
        main_functionality_page = MainFunctionality(driver)
        ...
        main_functionality_page.put_ingredient_into_basket()
        main_functionality_page.click_make_order()
        order_list_page.click_cross()
        personal_account_page.click_button_personal_account()
